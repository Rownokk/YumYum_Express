  ...
  return (
    <div className='explore-menu'id='explore-menu'>
        <h1>Explore Our Menu</h1>
         <p className='explore-menu-text'>Welcome to the heart of YumYum_Express, where every mealy is a delightful journey. Our menu is designed to cater to all tastes and preferences, offering a diverse selection of dishes that will tantalize your taste buds and satisfy your cravings. Whether you're in the mood for a quick snack or a gourmet feast, we've got something for everyone.
</p>
